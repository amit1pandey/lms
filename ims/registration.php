...
if(isset($_REQUEST['submit']))
{
	...
	mysql_query("insert into register (name, fathersname, address, city, state, country, phone, mobile, email, gender, qualification, course, picture, batchtime, startdate, enddate, fee, teacher, reference, dateofregistration, dateofentry, author) values('".$_REQUEST['name']."','".$_REQUEST['fathersname']."','".$_REQUEST['address']."','".$_REQUEST['city']."','".$_REQUEST['state']."','".$_REQUEST['country']."','".$_REQUEST['phone']."','".$_REQUEST['mobile']."','".$_REQUEST['email']."','".$_REQUEST['gender']."','".$_REQUEST['qualification']."','".$_REQUEST['courseinterested']."','".$filename."','".$_REQUEST['slottime']."','".$_REQUEST['startdate']."','".$enddate."','".$_REQUEST['fee']."','".$_REQUEST['teacher']."','".$_REQUEST['reference']."','".$_REQUEST['dateofregistration']."','".date('Y-m-d h:i:s')."','".$_SESSION['adminName']."')");
...
if(isset($_REQUEST['updaste']))
{
	...
	mysql_query("update register set name='".$_REQUEST['name']."',fathersName='".$_REQUEST['fathersname']."', address='".$_REQUEST['address']."', city='".$_REQUEST['city']."', state='".$_REQUEST['state']."', country='".$_REQUEST['country']."',phone='".$_REQUEST['phone']."', mobile='".$_REQUEST['mobile']."', email='".$_REQUEST['email']."', gender='".$_REQUEST['gender']."',qualification='".$_REQUEST['qualification']."', author='".$_REQUEST['teacher']."' where id='".$_REQUEST['id']."' ");
	$msg="Recored Updated";
	$success=true;
	$msgshow=true;
