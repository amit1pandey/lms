...
<?php
			...
			{
				$recx=mysql_query("select name from qualification where name='".$_REQUEST['name']."'");
				if(mysql_num_rows($recx)<1)
				{
					mysql_query("insert into qualification(name) values('".$_REQUEST['name']."')");
					$msg="Recored Entered";
					$success=true;
					$msgshow=true;
				}
			...
			if(isset($_GET['del']))
			{
            mysql_query("delete from qualification where id='".$_GET['del']."'");
			$msg="Recored Deleted";
			$success=true;
			$msgshow=true;
			}
			...
			if(isset($_GET['edit']))
			{
            $rec=mysql_query("select * from qualification where id='".$_GET['edit']."'");
			...
			{
				$recx=mysql_query("select name from qualification where name='".$_REQUEST['name']."' and id!='".$_REQUEST['id']."'" );
				if(mysql_num_rows($recx)<1)
				{
            	mysql_query("update qualification set name='".$_REQUEST['name']."' where id='".$_REQUEST['id']."'");
	...
	<div id="content">		
		...
		<div class="container">
            ...
            <div class="grid-24">
				<?php
                $result=mysql_query("select * from qualification order by id DESC")
				?>
				...
				<div class="widget widget-table">
					...
					<div class="widget-header">
						...
						<h3 class="icon aperture">List of Qualifications</h3>
					</div> <!-- .widget-header -->
					...
					<div class="widget-content">
                        ...
                        <?php while($row=mysql_fetch_array($result)) {?>
							<tr class="gradeA">
								...
								<td><a href="qualification.php?edit=<?php echo $row['id'];?>">Edit</a> | <a href="qualification.php?del=<?php echo $row['id'];?>">Del</a></td>
							</tr>
                            <?php } ?>															
						</tbody>
					</table>	
